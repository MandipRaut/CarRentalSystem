<nav class="ts-sidebar">
    <ul class="ts-sidebar-menu">
        ...
        <li><a href="createbrand.php"><i class="fa fa-files-o"></i> Brand | Create Brand</a></li>
        <li><a href="managebrand.php"><i class="fa fa-files-o"></i> Brand | Manage Brands</a></li>
        ...
        <li><a href="updatecontacts.php"><i class="fa fa-desktop"></i> Manage Contact Us</a></li>
        ...
        <li><a href="updatecontacts.php"><i class="fa fa-files-o"></i> Update Contact Info</a></li>
        <li><a href="subscribers.php"><i class="fa fa-table"></i> Manage Subscribers</a></li>
    </ul>
</nav>
